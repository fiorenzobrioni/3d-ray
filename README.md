...
- 🔍 **HDRI mipmap prefiltering** — pyramid lazy 2×2 box con peso `sin(θ)` (energy-conserving su equirect). `EnvironmentMap.SampleMip(dir, lod)` con interpolazione trilineare; pronta per glossy roughness-driven IBL.
