...
**Limiti.** Caster valutabili parametricamente (sfera/sfera trasformata); catene fino a 2 interfacce (vetro solido); luci d'area/geometriche (non le luci delta puntiformi/direzionali, né l'ambiente). Le caustiche multi-bounce/dispersive restano per le fasi successive (vedi `PLANNING.md`).
