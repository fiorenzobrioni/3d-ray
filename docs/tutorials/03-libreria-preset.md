# Libreria Universale dei Preset

Benvenuto nella raccolta ufficiale di configurazioni e asset pronti all'uso. In questo manuale troverai decine di snippet YAML già testati per illuminazioni cinematografiche, materiali PBR, inquadrature registiche e intere scene stage starter.

## Menu della Libreria
1. [Come Usare i Preset](03-libreria-preset/01-come-usare.md)
2. [Preset Camera](03-libreria-preset/02-preset-camera.md)
...
> [!NOTE]
> Per la modellazione avanzata tramite operazioni booleane, consulta la [04. Libreria dei Preset CSG](04-libreria-csg.md).
